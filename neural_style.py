...
# Basic options
parser.add_argument(
    "-style_image", help="Style target image", default="examples/inputs/seated-nude.jpg"
)
            ...
            if isinstance(layer, nn.Conv2d):
                ...
                if layerList["C"][c] in content_layers:
                    ...
                    loss_module = ContentLoss(
                        params.content_weight, params.normalize_gradients
                    )
                ...
                if layerList["C"][c] in style_layers:
                    ...
                    loss_module = StyleLoss(
                        params.style_weight, params.normalize_gradients
                    )
                    net.add_module(str(len(net)), loss_module)
...
def setup_multi_device(net):
    assert len(params.gpu.split(",")) - 1 == len(
        params.multidevice_strategy.split(",")
